    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      <header className="bg-white dark:bg-gray-900 border-b dark:border-gray-800">
        <div className="max-w-5xl mx-auto px-6 py-4 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900 dark:text-gray-100">Cost Dashboard</h1>
            <p className="text-xs text-gray-500 dark:text-gray-400">Token usage and cost analytics</p>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-5xl mx-auto px-6 py-8">
        ...
        {loading ? (
          <div className="text-center py-12 text-gray-400 dark:text-gray-500">Loading cost data...</div>
        ) : (
          <>
            {/* Summary cards */}
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg border dark:border-gray-700 p-6 mb-6">
              <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4">Cost by Model</h2>
                  ...
                  {modelEntries
                    ...
                    .map(([model, cost]) => (
                      <div key={model} className="flex items-center gap-3">
                        <span className="text-sm text-gray-600 dark:text-gray-400 w-48 truncate font-mono">{model}</span>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg border dark:border-gray-700 p-6">
              <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4">Model Pricing Reference</h2>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
                {[
                  ...
                  <div key={p.model} className="bg-gray-50 dark:bg-gray-800 rounded-lg p-3">
                    <p className="font-mono text-xs text-gray-800 dark:text-gray-200 mb-1">{p.model}</p>
                    <p className="text-xs text-gray-500 dark:text-gray-400">In: {p.input} / Out: {p.output}</p>
                    <p className="text-xs text-gray-400 dark:text-gray-500">per 1M tokens</p>
                  </div>
                ))}
              </div>
            </div>
